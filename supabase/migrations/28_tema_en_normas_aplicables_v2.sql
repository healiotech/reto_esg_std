-- ============================================================================
--  MIGRACIÓN 28 — Reincorpora `tema` a normas_aplicables tras el filtro de
--  aplicabilidad
-- ----------------------------------------------------------------------------
--  26_normas_aplicables_filtro.sql recreó normas_aplicables(uuid,uuid,boolean,text)
--  para agregar p_perfil_tamano + tipo_aplicabilidad/pregunta_aplicabilidad,
--  pero partió de la versión anterior a 21_tema_en_normas_aplicables.sql y
--  perdió la columna `tema` (alimenta la etiqueta de tema ESG del cuestionario).
--  Esta migración fusiona ambas: mismo filtro de aplicabilidad + `tema` de vuelta.
--  Puro pass-through, sin tocar el resto de la lógica.
-- ============================================================================
